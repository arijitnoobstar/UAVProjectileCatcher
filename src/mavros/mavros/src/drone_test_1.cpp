...
int main(int argc, char **argv)
{
    ...
    initial_location.pose.orientation.y = 0.99;
    initial_location.pose.orientation.z = 0.01;
    initial_location.pose.orientation.w = 0.01;
    initial_location.header.frame_id = "map";*/
    geometry_msgs::PoseStamped target_location;

    target_location.header.frame_id = "base_link";
    // takes at least 50 readings before moving to the drone (to ensure it consistently sees it)
    int min_readings = 50;
    int reading_count = 0;
