...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros)
  set(mavros_DEVEL_PREFIX /home/arijitnoobstar/UAVProjectileCatcher/devel/.private/mavros)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /home/arijitnoobstar/UAVProjectileCatcher/install)
...
if(NOT "/home/arijitnoobstar/UAVProjectileCatcher/devel/.private/mavros/include;/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/home/arijitnoobstar/UAVProjectileCatcher/devel/.private/mavros/include;/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arijitnoobstar/UAVProjectileCatcher/devel/.private/mavros/lib;/home/arijitnoobstar/UAVProjectileCatcher/devel/lib;/opt/ros/melodic/lib)
...
set(mavros_EXPORTED_TARGETS "mavros_generate_messages_cpp;mavros_generate_messages_eus;mavros_generate_messages_lisp;mavros_generate_messages_nodejs;mavros_generate_messages_py")
...
set(depends "diagnostic_msgs;diagnostic_updater;eigen_conversions;geographic_msgs;geometry_msgs;libmavconn;mavros_msgs;message_runtime;nav_msgs;pluginlib;roscpp;sensor_msgs;std_msgs;tf2_ros;trajectory_msgs;message_runtime")
