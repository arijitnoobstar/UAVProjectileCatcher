...
message(STATUS "mavros: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imavros:/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg/haha.msg" NAME_WE)
add_custom_target(_mavros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mavros" "/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg/haha.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(mavros
  "/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg/haha.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_nodejs(mavros
  "/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg/haha.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mavros
)

### Generating Services

### Generating Module File
_generate_module_nodejs(mavros
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mavros
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(mavros_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(mavros_generate_messages mavros_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/arijitnoobstar/UAVProjectileCatcher/src/mavros/mavros/msg/haha.msg" NAME_WE)
add_dependencies(mavros_generate_messages_nodejs _mavros_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(mavros_gennodejs)
add_dependencies(mavros_gennodejs mavros_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS mavros_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mavros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/mavros
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(mavros_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mavros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mavros\")")
  # install generated code
  install(
